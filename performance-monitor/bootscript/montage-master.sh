...
while [ "$(condor_status -total | grep -E 'Total[ \t]+[0-9]'|awk '{print $2}')" != "4" ];do
	sleep 5
done 
...
python /root/cluster/performance-monitor/producer/check_pegasus.py -i 73f1180c-98b1-480b-8708-e548415a4dff -m -d /home/pegasus-user/20131031/montage/pegasus-user/pegasus/montage -r 1 &
