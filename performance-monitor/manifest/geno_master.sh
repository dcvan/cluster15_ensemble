...
# start monitor 
python /root/cluster/performance-monitor/producer/check_pegasus.py -i {{param['exp_id']}} -m -d /home/pegasus-user/genomics/wf_exon_irods/pegasus-user/pegasus/exonalignwf -r {{param['workload']}} {% if param['deployment'] == 'standalone' %} -w -s {{param['site']}} {% endif %} &amp; 
