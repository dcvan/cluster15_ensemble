...
# start monitor 
python /root/cluster/performance-monitor/producer/check_pegasus.py -i {{param['exp_id']}} -m -s {{param['site']}} -d /home/pegasus-user/genomics/wf_exon_irods/pegasus-user/pegasus/exonalignwf -r {{param['run_num']}} &amp;
